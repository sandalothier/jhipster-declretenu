package com.fisc.declretenu.web.rest;

import com.fisc.declretenu.DeclretenuApp;
...
@SpringBootTest(classes = DeclretenuApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DeclretenuKafkaResourceIT {
    ...
    @Autowired
    private DeclretenuKafkaProducer producer;

    @Autowired
    private DeclretenuKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclretenuKafkaResource kafkaResource = new DeclretenuKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declretenu-kafka/publish?message=test"))
